...
%% ====================================
\section{Introdução}
Projeto de rede cabeada para os espaços denominados como salas de professores. São duas salas, sendo uma delas para professores do curso de Ciëncia da Computação e a outra para professores do curso de Ciências Biologicas. As duas salas serão subdivididas em baias totalizando 16 (dezeseis) espaços, distribuindo-se dois professores por baia. Alem dos 32 (trinta e dois) pontos de entrada de rede para os professores, necessita-se tambem de 16 pontos extras para telefonia voip, sendo um por baia. Por fim um ponto para uma impressora de uso comunitãrio.
O perfil de usuãrio limita-se a professores de informãtica e biologia somente, pois estes espaços sao exclusivos para os mesmos.
Ser adequado ao espaço uma rack de 12U de fixaçao aerea, com os respectivos equipamentos necessãrios para a estrutura de lõgica como switchs e patch panels. A conexao vira de infraestrutura de rede cabeada jã existente, sendo necessario somente a passagem cabeada do switch mais prõximo ao local.
