...
\title{Projeto de Cabeamento Estruturado para os Blocos E7 e E8 da UTFPR - Campus Santa Helena}					% Title of your article goes here
...
\author{Joéslei Brunetto}  	% Author name goes here
...
%% ====================================
\section{Introdução}
Projeto de rede cabeada para os espaços denominados como salas de professores. São duas salas, sendo uma delas para professores do curso de Ciência da Computação e a outra para professores do curso de Ciências Biológicas. As duas salas serão subdivididas em baias totalizando 16 (dezesseis) espaços, alocando-se dois professores por baia. Alem dos 32 (trinta e dois) pontos de entrada de rede para os professores, necessita-se tambem de 16 pontos extras para futura instalação de telefonia voip, sendo um por baia. Por fim um ponto para uma impressora de uso comunitário.
Será adicionada ao espaço uma rack de 12U de fixaçao aerea, com os respectivos equipamentos necessários para a estrutura de lógica como switchs e patch panels. A conexao virá de infraestrutura de rede cabeada já existente, sendo necessário somente a passagem cabeada partindo do switch mais próximo ao local.
...
O projeto de readequação da elétrica será desenvolvido pelo Departamento de Serviços Gerais.
...
Atualmente as duas salas citadas dispõe apenas de conexão wireless providas de um access point fixado no teto de um corredor próximo.
...
- Fixação da rack.
- Instalação das eletrocalhas para passagem da elétrica e lógica separadamente em todos os pontos determinados no projeto.
- Passagem do cabeamento da elétrica e finalização dos pontos elétricos.
...
O perfil de usuário limita-se a professores de informática e biologia somente, pois estes espaços sao exclusivos para os mesmos. Não há estimativa de crescimento nestes ambientes, pois o projeto já abrange o uso máximo dos espaços. Caso necessário novos pontos de lógica, ficarão disponíveis como sobra algumas portas dos equipamentos para tal, necessitando somente a passagem de novos cabos. As eletrocalhas para lógica também disponibilizará espaço extra para manobras.

\subsection{Usuários}
Relação da quantidade x perfil de usuários:
Máximo 16 baias para Professores Informática: Maior consumo de recursos de rede devido a aplicações características da área.
Máximo 16 baias para Professores Biologia: Menor consumo de recursos de rede, perfil de acesso básico a internet.
...
Planta física das salas envolvidas no projeto:
