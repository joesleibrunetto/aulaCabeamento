...
\title{Projeto de Cabeamento Estruturado para o Bloco E7 da UTFPR - Campus Santa Helena}					% Title of your article goes here
...
%% ====================================
\section{Introdução}
Projeto de rede cabeada para os espaços denominados como salas de professores. Sala esta dos professores do curso de Ciência da Computação. A sala será subdividida em baias totalizando 16 (dezesseis) espaços, alocando-se dois professores por baia. Alem dos 32 (trinta e dois) pontos de entrada de rede para os professores, necessita-se tambem de 32 pontos extras para futura instalação de telefonia voip, sendo dois por baia, ou um por baia sobrando um ponto para qualquer outra utilização. Por fim um ponto para uma impressora de uso comunitário.
